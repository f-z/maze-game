...
public class Person
{
    ...
    private void draw()
    {
        ...
        if(isVisible) {
            ...
            canvas.draw(this, color, new Polygon(xpoints, ypoints, 21));//21
            //canvas.wait(10);
        }
    }
